...
import com.fastscala.demo.examples.components.Widget
...
class SelectableRowsTableExamplePage extends SingleCodeExamplePage("/com/fastscala/demo/examples/tables/SelectableRowsTableExamplePage.scala") {
