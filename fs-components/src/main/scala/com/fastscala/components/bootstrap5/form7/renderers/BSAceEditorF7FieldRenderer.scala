...
import com.fastscala.components.form7.renderers.{F7AceEditorValidatableFieldRenderer, F7ValidatableFieldWithMainElemRenderer}
...
trait BSAceEditorF7FieldRenderer extends F7AceEditorValidatableFieldRenderer with BSStandardModifiableF7InputElemFieldRenderer {
