...
case class ChangedField(field: F6Field[_])(implicit renderedWithHints: Seq[RenderHint]) extends FormEvent

/**
 * Requested submit by, for example, pressing return.
 */
case class RequestedSubmit(onField: F6Field[_])(implicit renderedWithHints: Seq[RenderHint]) extends FormEvent
