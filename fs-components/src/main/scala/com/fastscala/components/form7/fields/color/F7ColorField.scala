...
class F7ColorField()(implicit renderer: TextF7FieldRenderer) extends F7InputFieldBase[String] with F7FieldWithPrefix with F7FieldWithSuffix with F7FieldWithMin with F7FieldWithStep with F7FieldWithMax {
