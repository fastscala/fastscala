...
class Student(
  ...
  override def table: TableWithLongIdSeqBacked[Student] = Student

  override def toString: String = s"Student(id=$id,name=$name)"
}

object Student extends TableWithLongIdSeqBacked[Student] {
...
class Course(
  ...
  override def table: TableWithLongIdSeqBacked[Course] = Course

  override def toString: String = s"Course(id=$id,name=$name)"
}

object Course extends TableWithLongIdSeqBacked[Course] {
...
class Student2Course(
  ...
  override def table: TableWithLongIdSeqBacked[Student2Course] = Student2Course

  override def toString: String = s"Student($studentId) => Course($courseId)"
}

object Student2Course extends TableWithLongIdSeqBacked[Student2Course] {
