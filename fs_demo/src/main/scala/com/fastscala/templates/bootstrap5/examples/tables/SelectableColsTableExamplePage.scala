...
class SelectableColsTableExamplePage extends SingleCodeExamplePage("/com/fastscala/templates/bootstrap5/examples/tables/SelectableColsTableExamplePage.scala") {
