...
class AnonymousPage extends SingleCodeExamplePage("/com/fastscala/demo/examples/AnonymousPage.scala") {
...
class VisualizeUploadedImageAnonymousPage(
                                           contentType: String,
                                           contents: Array[Byte]
                                         ) extends SingleCodeExamplePage("/com/fastscala/demo/examples/AnonymousPage.scala") {
